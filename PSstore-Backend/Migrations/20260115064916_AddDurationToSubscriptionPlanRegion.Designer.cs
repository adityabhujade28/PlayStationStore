...
namespace PSstore.Migrations
{
    ...
    [Migration("20260115064916_AddDurationToSubscriptionPlanRegion")]
    partial class AddDurationToSubscriptionPlanRegion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PSstore.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 15, 6, 49, 15, 725, DateTimeKind.Utc).AddTicks(7786)
                        });
                });
            ...
            modelBuilder.Entity("PSstore.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Age = 28,
                            CreatedAt = new DateTime(2026, 1, 15, 6, 49, 15, 725, DateTimeKind.Utc).AddTicks(7807),
                        ...
                        new
                        {
                            UserId = 2,
                            Age = 25,
                            CreatedAt = new DateTime(2026, 1, 15, 6, 49, 15, 725, DateTimeKind.Utc).AddTicks(7810),
            ...
            modelBuilder.Entity("PSstore.Models.UsersRegion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            RegionId = 1,
                            StartDate = new DateTime(2026, 1, 15, 6, 49, 15, 725, DateTimeKind.Utc).AddTicks(7828),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            RegionId = 2,
                            StartDate = new DateTime(2026, 1, 15, 6, 49, 15, 725, DateTimeKind.Utc).AddTicks(7829),
                            UserId = 2
                        });
                });
